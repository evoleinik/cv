...
\usepackage{multicol}
\usepackage{fontawesome5} % Use fontawesome5 instead
...
\setsansfont{Arial} % Different font for headings

% Custom colors
\definecolor{primarycolor}{RGB}{0, 79, 159}    % Professional blue
\definecolor{secondarycolor}{RGB}{100, 100, 100} % Subtle gray
\definecolor{linkcolor}{RGB}{0, 112, 201}      % Link blue
\definecolor{headerbg}{RGB}{240, 240, 240}     % Light gray background
