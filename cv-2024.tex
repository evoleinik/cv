...
{\setstretch{1.2}
Technical founder building at the intersection of AI and commerce. Currently Co-Founder \& CTO of AirShelf AI (Antler-backed, Singapore), building infrastructure that makes brands discoverable across AI agents. Previously Co-Founder \& CTO of 12Go, APAC's leading ground transportation OTA --- scaled to \textbf{30,000 bookings daily}, \textbf{45-person team}, and \textbf{\$500K daily GMV} over a decade.}

% Notable Achievements
\section*{Notable Achievements}
\begin{itemize}
    \item \textbf{Founded AirShelf AI} --- agentic commerce infrastructure making brands discoverable across AI agents. Antler-backed. First enterprise pilot signed within 4 months.
...
\begin{itemize}
    \item Infrastructure layer between retailers and AI agents --- ingests product data, enriches it into verified ``Decision Packs'', serves to ChatGPT, Gemini, Perplexity, and any AI agent.
    \item Designed and shipped end-to-end: dashboard, semantic search API (177 stores / 9 APAC markets), AI hallucination detection, agent commerce protocol integration.
    \item First paid pilot within 4 months. Selected for HP Garage 2.0 (21-country APAC network).
\end{itemize}
